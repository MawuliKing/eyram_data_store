...
// ✅ MODIFIED QUERY: This is the key to the fix.
// It now finds orders that are 'Processing' if EITHER:
// 1. Their `updated_at` timestamp is more than an hour old (for new orders).
// OR
// 2. Their `created_at` timestamp is more than an hour old (to catch old, stuck orders).
$stmt = $conn->prepare("
...
// The rest of the script's logic is perfectly fine and remains unchanged.
// It will loop through the orders found by the improved query and complete them.
